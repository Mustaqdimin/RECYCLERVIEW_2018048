...
public class NamaAdapter extends RecyclerView.Adapter<NamaAdapter.NamaViewHolder> {
    ...
    int images[];
    Context context;
    public NamaAdapter(Context ct, String s1[], String s2[],
                          String s3[], int img[]){
        context = ct;
        data1 = s1;
        data2 = s2;
    ...
    @NonNull
    @Override
    public NamaAdapter.NamaViewHolder
    onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater =
                LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.item_nama, parent, false);
        return new NamaViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull NamaAdapter.NamaViewHolder holder, int position) {
    ...
    public class NamaViewHolder extends
